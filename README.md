...
> | Celdas suprimidas | id **privado** `0x104` (512 bytes, **escribible**) → máscara de celdas de tile (64×64, 8 px, coords del frame con bordes) que `render_line` pinta con el backdrop (ocultar tile/fondo/texto por hash; el frontend lo setea sólo en el frame visible) | _(esta rama)_ |
>
